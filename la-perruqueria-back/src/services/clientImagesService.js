const { collection, getDocs, getDoc, doc, setDoc, updateDoc, deleteDoc } = require("firebase/firestore");
...
module.exports = { fetchClientImages, fetchClientImageDetails, createClientImage, updateClientImage, deleteClientImage };
